...
import numpy as np
# reading CSV file
dataInput = read_csv("D:\materials of JI\\4903robotic arm\\ansys working\\ansys scripting\\ft_circle1.csv")
dataOutput = "D:\materials of JI\\4903robotic arm\\ansys working\\ansys scripting\\output_circle_bottomsurf_nodes_ft.csv"
...
def judgement(x,y,dx,dy,da):
    ...
    if (x_cen_trans ** 2  + y_cen_trans **2 >= R ** 2) and (x ** 2 + y ** 2 <= R ** 2):
        return 1
    return 0
